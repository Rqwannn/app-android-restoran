...
public class LihatMinuman extends AppCompatActivity {
    ...
    public void setMenu(String Kategori){
        ...
        rlData = new LinearLayoutManager(LihatMinuman.this, LinearLayoutManager.VERTICAL, false);
        ...
        FeedBack.enqueue(new Callback<ResponseAPI>() {
            ...
            public void onResponse(Call<ResponseAPI> call, Response<ResponseAPI> response) {
                ...
                if (status){
                    raData = new LihatMenuAdapter(LihatMinuman.this, response.body().getMenu(), kategori);
            ...
            public void onFailure(Call<ResponseAPI> call, Throwable t) {
                Toast.makeText(LihatMinuman.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}